...
void Decoders::handlePinVolChanges(MicroCom::Pins pin, Voltage value){
    ...
    if(pin==MicroCom::DE_G1 || pin==MicroCom::DE_G2a || pin==MicroCom::DE_G2b){
        ...
        if(pins[MicroCom::DE_G1]==high && pins[MicroCom::DE_G2a]==low && pins[MicroCom::DE_G2b]==low){
            int rst = 0;
            ...
            qDebug()<<"y0="<<pins[MicroCom::DE_y0];
            qDebug()<<"y1="<<pins[MicroCom::DE_y1];
            qDebug()<<"y2="<<pins[MicroCom::DE_y2];
            qDebug()<<"y3="<<pins[MicroCom::DE_y3];
            qDebug()<<"y4="<<pins[MicroCom::DE_y4];
            qDebug()<<"y5="<<pins[MicroCom::DE_y5];
            qDebug()<<"y6="<<pins[MicroCom::DE_y6];
            qDebug()<<"y7="<<pins[MicroCom::DE_y7];
